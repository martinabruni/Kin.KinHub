...
Genera un "transcript" di repository C#:
- Seleziona file con estensione: .cs, .csproj, .sln
- Esclude directory: .git, bin, obj, node_modules, artifacts (configurabili)
- Produce:
  - header con metadati
...
ALLOWED_EXTENSIONS_DEFAULT = {".cs", ".csproj", ".sln", ".slnx"}
...
def default_outfile(resolved_root: Path) -> Path:
    out_dir = resolved_root / "artifacts" / "transcripts"
