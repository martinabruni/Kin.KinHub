...
- esegue il bundle EF con una connection string Azure SQL `Authentication=Active Directory Default`;
...
- readiness 503: controllare Azure SQL, bootstrap KinHub, settings database, principal Entra e migration.
